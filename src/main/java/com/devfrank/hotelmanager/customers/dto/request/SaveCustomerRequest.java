...
public record SaveCustomerRequest(
        @NotBlank(message = ValidationConstants.CUSTOMER_NAMES_NOTBLANK)
        @Size(min = 2, max = 150, message = ValidationConstants.CUSTOMER_NAMES_SIZE)
        String names,

        @NotBlank(message = ValidationConstants.CUSTOMER_SURNAMES_NOTBLANK)
        @Size(min = 2, max = 150, message = ValidationConstants.CUSTOMER_SURNAMES_SIZE)
        String surnames,

        @NotBlank(message = ValidationConstants.CUSTOMER_EMAIL_NOTBLANK)
        ...
        @NotBlank(message = ValidationConstants.CUSTOMER_DOCUMENT_TYPE_NOTBLANK)
        ...
        @NotBlank(message = ValidationConstants.CUSTOMER_DOCUMENT_NUMBER_NOTBLANK)
