...
public class ValidationConstants {
    ...
    public static final String CUSTOMER_NAMES_NOTBLANK = "Los nombres no pueden estar vacíos";
    public static final String CUSTOMER_NAMES_SIZE = "Los nombres deben tener entre 2 y 150 caracteres";
    public static final String CUSTOMER_SURNAMES_NOTBLANK = "Los apellidos no pueden estar vacíos";
    public static final String CUSTOMER_SURNAMES_SIZE = "Los apellidos deben tener entre 2 y 150 caracteres";
    public static final String CUSTOMER_EMAIL_NOTBLANK = "El correo electrónico no puede estar vacío";
    ...
    public static final String CUSTOMER_DOCUMENT_TYPE_NOTBLANK = "El tipo de documento es obligatorio";
    ...
    public static final String CUSTOMER_DOCUMENT_NUMBER_NOTBLANK = "El número de documento es obligatorio";
